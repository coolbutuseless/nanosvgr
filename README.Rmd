...
`nanosvgr` reads SVG  images as polygons
...
of polygon/bezier information and associated graphical parameters.
...
* `points` - A list of data.frames - one data.frame for each
        shape containing the polygons/polylines derived from the beziers. 
        Data format is the 
        same as `beziers` except the coordinates are for the polygons 
